                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="{{ route('sections.create') }}"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach( $data as $value )
                            <tr class="odd gradeX">
                                ...
                                <td> <img class="table_img img-preview img-responsive" src="{{ URL::asset('public/uploads/sections/'.$value->photo) }}"></td>
                                <td> {{ $value->name }} </td>
                                <td> {{ $value->translate('en')->name }} </td>
                                <td> <a href="{{ route('sections.subsections', $value->id) }}"><i class="icon-pencil"></i> عرض</a></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            <li>
                                                <a href="{{ route('sections.edit', $value->id) }}">
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    $.ajax({
                        url: "{{ url('/') }}" + "/dashboard/sections/destroy" ,
                        type: "POST",
