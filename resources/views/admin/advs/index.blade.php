...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ route('advs.index') }}">الاعلانات  الخاصة</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="{{ route('advs.create') }}"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach( $data as $value )
                            <tr class="odd gradeX">
                                ...
                                <td> <img class="table_img img-preview img-responsive" src="{{ URL::asset('public/uploads/advs/'.$value->photo) }}"></td>        
                                <td> <span class="badge badge-roundless {{ $value->status ? "badge-success" : "label-default" }}"> {{ $value->status ? 'مفعل' :  'غير مفعل' }}</span></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            <li>
                                                <a href="{{ route('advs.edit', $value->id) }}">
                                                    <i class="icon-pencil"></i> تعديل
                                                </a>
                                            </li>
                                            <li>
                                                <a class="delete_data" data="{{ $value->id }}" data_name="{{ $value->id }}">
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    $.ajax({
                        url: "{{ url('/') }}" + "/dashboard/advs/destroy" ,
                        type: "POST",
