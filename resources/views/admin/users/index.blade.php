            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                 <a class="btn sbold green" href="{{ route('users.create') }}"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach( $data as $value )
                            <tr class="odd gradeX">
                                ...
                                <td> <span class="badge badge-roundless {{ $value->status ? "badge-success" : "label-default" }}"> {{ $value->status ? 'نشط' :  'موقوف' }}</span></td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a class="delete_data" data="{{ $value->id }}" data_name="{{ $value->username }}">
...
//                                html: "لقد تم تغيير حالة تفعيل  " + swal_text + " " + "بنجاح",
            ...
            swal({
                ...
                $.ajax({
                    url: "{{ url('/') }}" + "/dashboard/users/destroy" ,
                    type: "POST",
