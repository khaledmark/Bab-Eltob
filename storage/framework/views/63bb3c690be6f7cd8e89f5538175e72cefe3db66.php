...
<?php $__env->startSection('page_header'); ?>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="<?php echo e(route('regions.index')); ?>">المناطق</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="<?php echo e(route('regions.create')); ?>"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th> اسم المنطقة بالعربية   </th>
                            <th> اسم المنطقة بالإنجليزية  </th>
                            <th> اسم المدينة  </th>
                            <th> العمليات </th>
                        </tr>
                        </thead>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            <li>
                                                <a href="<?php echo e(route('regions.edit', $value->id)); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                var swal_text = ' المنطقة ' + $(this).attr('data_name');
                ...
                swal({
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/')); ?>" + "/dashboard/regions/destroy" ,
                        type: "POST",
