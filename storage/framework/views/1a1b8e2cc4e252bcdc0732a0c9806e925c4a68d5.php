...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/admin/css/bootstrap-rtl.min.css')); ?>" type="text/css">
...
<div class="container">
    <div class="content">
        ...
        <div class="text-right">
            <a class="btn sbold green" href="<?php echo e(route('dashboard')); ?>">عودة للرئيسية
