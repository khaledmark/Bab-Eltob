<?php $__env->startSection('title'); ?>
    <?php echo e(trans('admin.itemsEdit')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/admin/css/bootstrap-fileinput.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/admin/css/dropzone.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/admin/css/basic.min.css')); ?>">
...
<?php $__env->startSection('page_header'); ?>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="<?php echo e(route('items.index')); ?>"><?php echo e(trans('admin.itemsShow')); ?></a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span><?php echo e(trans('admin.itemsEdit')); ?></span>
            </li>
        </ul>
    </div>

    <h1 class="page-title"> <?php echo e(trans('admin.itemsIndex')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($item, ['method' => 'PATCH', 'url' => route('items.update', $item->id),'class' => 'form-horizontal', 'files' => 'true']); ?>


    <input id="oldImages" name="oldImages" type="hidden" value="<?php echo e($imagesIds); ?>">
    <input id="newImages" name="newImages" type="hidden" value="<?php echo e($imagesIds); ?>">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="name" name="name" value="<?php echo e($item->name); ?>" class="form-control" placeholder="اسم الاعلان" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="price" name="price" type="number"value="<?php echo e($item->price); ?>"  class="form-control" placeholder="سعر الاعلان" step="0.50" min="0.50">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="city_id" class="col-lg-3 control-label"><?php echo e(trans('admin.adminsADCity')); ?></label>
                            <div class="col-lg-9">
                                <div class=" input-group select2-bootstrap-append">
                                    <select id="city_id" name="city_id" value="<?php echo e($item->city_id); ?>" class="city form-control select2-allow-clear">
                                        <option value="<?php echo e($item->city->id); ?>"selected><?php echo e($item->city->name); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group select2-bootstrap-append">
                                    <select id="region_id" name="region_id" value="<?php echo e($item->region_id); ?>" class="region form-control select2-allow-clear">
                                        <option value="<?php echo e($item->region->id); ?>" selected><?php echo e($item->region->name); ?></option>
                            ...
                            <div class="col-lg-9">
                                <div class=" input-group select2-bootstrap-append">
                                    <select id="" name=""  class="section form-control select2-allow-clear">
                                        <option value="<?php echo e($item->subSection->section->id); ?>" selected><?php echo e($item->subSection->section->name); ?></option>
                            ...
                            <div class="col-lg-9">
                                <div class=" input-group select2-bootstrap-append">
                                    <select id="sub_section_id" name="sub_section_id"  class="subsection form-control select2-allow-clear">
                                        <option value="<?php echo e($item->subSection->id); ?>" selected><?php echo e($item->subSection->name); ?></option>
                                        <?php $__currentLoopData = $subSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($section->id); ?>" ><?php echo e($section->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <textarea id="description" name="description" class="form-control autosizeme" rows="10" placeholder="وصف الاعلان"><?php echo e($item->description); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        <label for="address" class="col-lg-3 control-label">العنوان بالتفصيل</label>
                        <div class="col-lg-9">
                            <input id="address" name="address" value="<?php echo e($item->address); ?>" class="form-control" placeholder="العنوان بالتفصيل" >
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-group">
                            <label for="lat" class="col-lg-3 control-label"><?php echo e(trans('admin.adminsADLat')); ?></label>
                            <div class="col-lg-9">
                                <input id="lat" name="lat" type="text" value="<?php echo e($item->lat); ?>" class="form-control">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="long" class="col-lg-3 control-label"><?php echo e(trans('admin.adminsADLong')); ?></label>
                            <div class="col-lg-9">
                                <input id="long" name="lang" type="text" value="<?php echo e($item->lang); ?>" class="form-control">
                            </div>
                        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(URL::asset('public/admin/js/editMap.js')); ?>"></script>
    ...
    <script src="<?php echo e(URL::asset('public/admin/js/dropzone.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/admin/js/form-dropzone.min.js')); ?>"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.city').on("change", function () {
                ...
                $.ajax({
                    url: "<?php echo e(url('/')); ?>" + "/dashboard/cities/change-regions",
                    type: "POST",
            ...
            $('.section').on("change", function () {
                ...
                $.ajax({
                    url: "<?php echo e(url('/')); ?>" + "/dashboard/sections/change-sunsections",
                    type: "POST",
