<?php $__env->startSection('title'); ?>
    <?php echo e(trans('admin.itemsAdd')); ?>
...
<?php $__env->startSection('page_header'); ?>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span><?php echo e(trans('admin.itemsAdd')); ?></span>
            </li>
        </ul>
    </div>
...
<?php $__env->startSection('content'); ?>
    <?php echo Form::open([ 'url' => route('items.store'), 'class' => 'form-horizontal', 'files' => 'true']); ?>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="lat" name="lat" type="text" value="<?php echo e(old('lat')); ?>" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="long" name="lang" type="text" value="<?php echo e(old('long')); ?>" class="form-control">
                            </div>
                        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(URL::asset('public/admin/js/map.js')); ?>"></script>
