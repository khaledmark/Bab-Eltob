...
<?php $__env->startSection('page_header'); ?>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>إضافة قسم رئيسى </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title"> الأقسام الرئيسية
        <small>إضافة قسم رئيسى جديد</small>
    </h1>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-lg-8">
        <div class="portlet light bordered">
            <div class="portlet-body form">
                <?php echo Form::open([ 'url' => route('sections.store'), 'class' => 'form-horizontal','files'=>true ]); ?>


                    <div class="form-group">
                        <label for="name" class="col-lg-3 control-label"> اسم القسم بالعربية </label>
                        <div class="col-lg-9">
                            <input type="text" id="name" name="name" class="form-control " placeholder="اسم القسم بالعربية" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="name_en" class="col-lg-3 control-label"> اسم القسم بالانجليزية </label>
                        <div class="col-lg-9">
                            <input type="text" id="name_en" name="name_en"  class="form-control " placeholder="اسم القسم بالانجليزية" required>
                        </div>
                    </div>
