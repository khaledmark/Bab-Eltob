...
<?php $__env->startSection('page_header'); ?>
    ...
    <h1 class="page-title"> عرض الإعلانات
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <a class="btn sbold green" href="<?php echo e(route('items.create')); ?>"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="odd gradeX">
                                ...
                                <td><a href="<?php echo e(route('items.show', $value->id)); ?>"><i class="icon-pencil"></i> <?php echo e($value->name); ?> </a></td>
                                <td> <?php echo e($value->user->username); ?> </td>
                                <td> <?php echo e($value->price); ?> </td>
                                <td> <?php echo e($value->description); ?> </td>
                                <td> <span class="badge badge-roundless <?php echo e($value->status ? "badge-success" : "label-default"); ?>"> <?php echo e($value->status ? 'مفعل' :  'موقوف'); ?></span></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            <li>
                                                <a href="<?php echo e(route('items.show', $value->id)); ?>">
                                                    <i class="icon-eye"></i> عرض
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('items.edit', $value->id)); ?>">
                                                    <i class="icon-pencil"></i> تعديل
                                                </a>
                                            </li>
                                            <li>
                                                <a class="changeStatus" data="<?php echo e($value->id); ?>" data_name="<?php echo e($value->name); ?>" status="<?php echo e($value->status ? '0' : '1'); ?>">
                                                    <i class="fa fa-key"></i> تغيير حالة الاعلان 
                                                </a>
                                            </li>
                                            <li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                var swal_text = ' الإعلان  ' + $(this).attr('data_name');
                ...
                swal({
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/')); ?>" + "/dashboard/items/destroy" ,
                        type: "POST",
             ...
             $('body').on( "click", '.changeStatus', function( ) {
                ...
                var swal_text = 'للاعلان ' + $(this).attr('data_name');
                var swal_title = 'هل أنت متأكد من تغيير حالة الاعلان  ؟';
                ...
                swal({
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/')); ?>" + "/dashboard/items-change-status" ,
                        type: "POST",
                        data: {_token: CSRF_TOKEN, 'item_id': item_id, 'status': status, 'url': 'items'},
                    })
                    .done(function(reseived_data) {
                        var parsed_data = $.parseJSON(reseived_data);
