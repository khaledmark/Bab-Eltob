                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="<?php echo e(route('sub-sections.create')); ?>"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th> الصورة </th>
                            <th> اسم القسم الفرعي بالعربية  </th>
                            <th> اسم القسم الفرعي بالإنجليزية </th>
                            <th> العمليات </th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="odd gradeX">
                                ...
                                <td> <img class="table_img img-preview img-responsive" src="<?php echo e(URL::asset('public/uploads/subsections/'.$value->photo)); ?>"></td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            <li>
                                                <a href="<?php echo e(route('sub-sections.edit', $value->id)); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                var swal_text = ' القسم الرئيسى  ' + $(this).attr('data_name');
                ...
                swal({
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/')); ?>" + "/dashboard/sub-sections/destroy" ,
                        type: "POST",
