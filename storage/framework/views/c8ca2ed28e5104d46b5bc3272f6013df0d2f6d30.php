...
<?php $__env->startSection('page_header'); ?>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="<?php echo e(route('advs.index')); ?>">الاعلانات  الخاصة</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>عرض الاعلانات  الخاصة </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title"> عرض الاعلانات  الخاصة
        <small>عرض الاعلانات  الخاصة  </small>
    </h1>
<?php $__env->stopSection(); ?>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="<?php echo e(route('advs.create')); ?>"> إضافة جديد
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="odd gradeX">
                                ...
                                <td> <img class="table_img img-preview img-responsive" src="<?php echo e(URL::asset('public/uploads/advs/'.$value->photo)); ?>"></td>        
                                <td> <span class="badge badge-roundless <?php echo e($value->status ? "badge-success" : "label-default"); ?>"> <?php echo e($value->status ? 'مفعل' :  'غير مفعل'); ?></span></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            <li>
                                                <a href="<?php echo e(route('advs.edit', $value->id)); ?>">
                                                    <i class="icon-pencil"></i> تعديل
                                                </a>
                                            </li>
                                            <li>
                                                <a class="delete_data" data="<?php echo e($value->id); ?>" data_name="<?php echo e($value->id); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                var swal_text = 'الاعلان الخاص' + $(this).attr('data_name');
                ...
                swal({
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/')); ?>" + "/dashboard/advs/destroy" ,
                        type: "POST",
