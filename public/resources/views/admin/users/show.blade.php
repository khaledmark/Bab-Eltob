    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="portlet light ">
                ...
                <div>
                    <h4 class="profile-desc-title"> حالة الحساب </h4>
                    <span class="btn-circle label label-sm {{ $user->account_status ? "label-success" : "label-default" }}">
                        {{ $user->account_status ? trans('admin.settingsOpen') : trans('admin.settingsClose') }}
                    </span>
                </div>
