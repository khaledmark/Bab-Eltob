...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>عرض مدة الدفع </span>
            </li>
        </ul>
    </div>

    <h1 class="page-title"> عرض مدة الدفع
        <small>عرض مدة الدفع  </small>
    </h1>
@endsection
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="btn-group">
                                    <a class="btn sbold green" href="{{ route('paymentDuration.create') }}"> إضافة جديد
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                var swal_text = 'المدة ' + $(this).attr('data_name');
                ...
                swal({
                    ...
                    $.ajax({
                        url: "{{ url('/') }}" + "/dashboard/durations/destroy" ,
                        type: "POST",
