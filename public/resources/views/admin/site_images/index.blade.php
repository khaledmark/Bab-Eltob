...
@section('title')
    {{ $type == 'slider' ? trans('admin.sliderIndex') : trans('admin.appImagesIndex') }}
@endsection
...
@section('page_header')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ $type == 'slider' ? trans('admin.sliderShow') : trans('admin.appImagesShow') }}</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">{{ $type == 'slider' ? trans('admin.sliderShow') : trans('admin.appImagesShow') }}
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="{{ URL::asset('uploads/site_images/'. $value->image) }}" target="_blank">
                                        <img class="table_img img-preview img-responsive" src="{{ URL::asset('public/uploads/site_images/'.$value->image) }}">
                                    </a>
                                </td>
                                <td>
                                    <div class="btn-group">
