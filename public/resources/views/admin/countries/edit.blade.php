            ...
            <div class="portlet-body form">
                {!! Form::model($faq, ['method' => 'PATCH', 'url' => route('faqs.update', $faq->id),'class' => 'form-horizontal']) !!}
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" id="ar_question" name="ar_question"  value="{{ $faq->ar_question }}" class="form-control " placeholder="السؤال بالعربية">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="ar_answer" class="col-lg-3 control-label"> الإجابة بالعربية </label>
                        <div class="col-lg-9">
                            <textarea id="ar_answer" name="ar_answer"  value="{{ $faq->ar_answer  }}" class="form-control autosizeme" rows="10" placeholder="الإجابة بالعربية ">  </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" id="en_question" name="en_question"  value="{{ $faq->en_question }}" class="form-control autosizeme" rows="10" placeholder="السؤال بالإنجليزية">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea id="en_answer" name="en_answer"  value="{{ $faq->en_answer }}"  class="form-control autosizeme" rows="10" placeholder="الإجابة بالانجليزية">  </textarea>
                        </div>
                    </div>
