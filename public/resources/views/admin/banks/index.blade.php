                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach( $data as $value )
                            <tr class="odd gradeX">
                                ...
                                <td> <img class="table_img img-preview img-responsive" src="{{ URL::asset('public/uploads/banks/'.$value->photo) }}"></td>
                                <td> {{ $value->name }} </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                var swal_text = 'البنك ' + $(this).attr('data_name');
                ...
                swal({
                    ...
                    $.ajax({
                        url: "{{ url('/') }}" + "/dashboard/banks/destroy" ,
                        type: "POST",
